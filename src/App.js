    ...
    <div className="wrapper clear">
      <header className="d-flex justify-between align-center p-40">
        ...
        <img src="/img/logo.png" alt="Logo"/>
          <div className="headerInfo">
            <h3 className="text-uppercase">DinkinsX Sneakers</h3>
            <p className="opacity-7">Магазин Красноярских кроссовок</p>
          </div>
        </div>
      ...
      <div className="content p-40">
        ...
        <div className="d-flex">
          ...
          <div className="card">
            <img width={133} height={112} src="/img/sneakers/3.jpg" alt="sneakers1"/>
            <h5>Мужские Кроссовки Nike Blazer Mid Suede</h5>
            <div className="d-flex justify-between align-center">
              <div className="d-flex flex-column">
                <span>Цена:</span>
          ...
          <div className="card">
            <img width={133} height={112} src="/img/sneakers/4.jpg" alt="sneakers1"/>
